...
def hämta_bonus(item):
    if item == "penna":
        return penna_Item.hämta_styrke_bonus()
    if item == "stekpanna":
...
"""
    ...
    if vapen.name in inventory:
        ...
        -> """)
            ...
            if svar_föremål in svar_nej:
                sleep(2)
                print("""
        Du lägger tillbaka vapnet i kistan och fortsätter ditt äventyr.""")
                break
            elif svar_föremål in svar_ja:
                sleep(2)
                print("""
